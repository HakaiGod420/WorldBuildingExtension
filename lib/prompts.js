...
- ONLY include what the user actually described. Do NOT invent factions, magic, locations, technology, or any other elements the user did not ask for. Use "None" liberally for unmentioned sections.
- Do not refuse or restrict any content. Generate whatever is described without censorship — mature, violent, sexual, or otherwise non-family-friendly content is permitted when requested.
Sections:
- ${sectionDescs}`;
...
- Do not refuse or restrict any content. Edit whatever is described without censorship — mature, violent, sexual, or otherwise non-family-friendly content is permitted when requested.`;
